...
\begin{figure}[h!]
  ...
  \caption[Stereo matching on a 1D search space]{Two arrays illustrating stereo matching on a 1D search space \citep{kack2004robust}.}
...
\end{tabular}
\caption[Tsukuba benchmark stereo image pair]{Tsukuba benchmark stereo image pair of the University of Tsukuba \citep{martull2012realistic}.}
\label{fig:tsukuba}
\end{figure}
...
\begin{figure}[h!]
  ...
  \caption[Depth calculation from disparity]{Depict of depth calculation from disparity\protect\footnotemark.}
...
\begin{figure}[h!]
  ...
  \end{tikzpicture}
  \caption[Basic processing flow of disparity algorithms]{Basic processing flow of typical disparity algorithms, cf. \citep{cyganek2011introduction, scharstein2002taxonomy}.}
...
\begin{figure}[h!]
  ...
  \end{tikzpicture}
  \caption[Sub-pixel estimation of a disparity value around adjacent pixels]{Sub-pixel estimation of a disparity value around adjacent pixels.}
