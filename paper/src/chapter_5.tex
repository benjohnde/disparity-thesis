...
\noindent It is clear to see that.

\subsubsection{Outliers}

Beforehand, the investigation of outliers in a whole sequence of consecutive frames was mentioned.
During the evaluation, only one sequence tended to have outliers, the book scene of the Cambridge dataset.
In this scene, one frame has significant more bad matched pixels than all the others.
