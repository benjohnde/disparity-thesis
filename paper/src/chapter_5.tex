...
\centering
\begin{tabular}{cc}
\subfloat[ground-truth heatmap]{\includegraphics[width=0.49\textwidth]{src/images/evaluation/snsm-tsukuba-ground-truth.png}} &
\subfloat[computed disparity-map]{\includegraphics[width=0.49\textwidth]{src/images/evaluation/snsm-tsukuba-disparity-map.png}} \\
\subfloat[outliers in SNSM]{\includegraphics[width=0.49\textwidth]{src/images/evaluation/snsm-tsukuba-outliers.png}} &
\subfloat[outliers in SAD-IGMCT]{\includegraphics[width=0.49\textwidth]{src/images/evaluation/snsm-tsukuba-outliers-igmct.png}}
\end{tabular}
...
\subsubsection{Depth-discontinuity}
...
\centering
\begin{tabular}{cc}
\subfloat[left image]{\includegraphics[width=0.49\textwidth]{src/images/evaluation/outliers2/tunnel-left.png}} &
\subfloat[ground-truth heatmap]{\includegraphics[width=0.49\textwidth]{src/images/evaluation/outliers2/tunnel-ground-truth.png}} \\
\subfloat[outliers in OpenCV BM]{\includegraphics[width=0.49\textwidth]{src/images/evaluation/outliers2/tunnel-outliers-noc-2.png}} &
\subfloat[outliers in ELAS]{\includegraphics[width=0.49\textwidth]{src/images/evaluation/outliers2/tunnel-outliers-noc-3}}
\end{tabular}
\caption{Heatmaps for tunnel scene}
\label{fig:eval:heat:tunnel}
\end{figure}

\noindent bla. salient. regions.
%todo bla salient regions
...
%todo describe me
%todo add example picture of tank with 14,28 and 40 with motion
...
\caption[Overview on runtime]{Overview on runtime of different algorithms}
\end{table}
