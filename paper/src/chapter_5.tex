...
\caption[Result table for the impact of noise]{Result table for the impact of noise, focusing on PBMP$_{noc,1px}$}
\end{table}
...
\caption[Result table for the impact of video compression]{Result table for the impact of video compression, focusing on PBMP$_{noc,1px}$}
\end{table}
