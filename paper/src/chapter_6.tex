...
Third, as a lot of related work regarding spatiotemporal consistency was read and processed, a simple naive stereo matcher which respects the spatiotemporal context was implemented and evaluated.
