...
\tikzstyle{rblock} = [text width=10em, rectangle, draw, fill=gray!25, text centered, rounded corners, minimum height=3em]
\tikzstyle{cloud} = [text width=6.5em, ellipse, draw, fill=gray!10, text centered, rounded corners, minimum height=3em]
\begin{figure}[h!]
  \centering
