...
The following approaches have in common that they want to deal with the occurrence of noise.
...
%todo maybe a bit more about DBC Grid vs Temporal DBC Grid
%todo hint 5 frames are observed for calculating the disparity map of one frame
...
This entails the need of changing the disparity after a stereoscopic movie was recorded.
...
Stereoscopic warping is image warping with the help of disparity mapping operators.

%todo one or two sentences about the outcome
