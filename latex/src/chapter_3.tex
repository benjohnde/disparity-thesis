...
The main idea behind MRF in combination with computer vision problems is the formulate the so called labelling problem in such a way, that each pixel has a likelihood to belong to a certain label \citep{tamassia2013handbook}.
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.5\textwidth]{src/images/mrf-example.png}
