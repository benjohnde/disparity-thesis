...
For the later evaluation phase a desktop computer with an i5-2500k @ 3.0GHz was used.
As IDE CLion\footnote{\url{https://www.jetbrains.com/clion/}} from JetBrains was used.
...
Those docker containers work in a chroot\footnote{Chroot stands for "change root" and helps to change the accessible root directory for a current process.} environment and are isolated from other processes.
