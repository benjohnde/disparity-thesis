...
\begin{frame}[fragile]{Results (2) - Depth-discontinuity mask}
  \begin{figure}[h!]
  \centering
...
\begin{frame}[fragile]{Results (5) - Outliers example}
  \begin{figure}[h!]
  \centering
  \begin{tabular}{ccc}
...
\begin{frame}[fragile]{Results (6) - Video compression}
  \begin{figure}[h!]
  \centering
...
\begin{frame}[fragile]{Results (7) - Video compression examples}
  \begin{figure}[h!]
  \centering
  \begin{tabular}{ccc}
...
\begin{frame}[fragile]{Results (8) - Runtime}
  \begin{figure}[h!]
  \centering
...
\begin{frame}[fragile]{Results (9) - SVDDD}
  \begin{figure}[h!]
  \centering
  \begin{tabular}{ccc}
