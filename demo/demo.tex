...
\begin{frame}[fragile]{Results (3) - Outliers}
  \begin{figure}[h!]
  \centering
...
\begin{frame}[fragile]{Results (4) - Outliers example}
  \begin{figure}[h!]
  \centering
  \begin{tabular}{ccc}
...
\begin{frame}[fragile]{Results (6) - Video compression examples}
  \begin{figure}[h!]
  \centering
  \begin{tabular}{ccc}
...
\begin{frame}[fragile]{Results (7) - Runtime}
  \begin{figure}[h!]
  \centering
...
\begin{frame}[fragile]{Results (8) - SVDDD}
  \begin{figure}[h!]
  \centering
  \begin{tabular}{ccc}
